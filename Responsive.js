const form = (event) => {
    ...
    const radioButtonsValue = document.querySelector('input[name="groupgender"]:checked').value;
    ...
    const infoget = { email: email, fullname: fullname, gender: radioButtonsValue, country:country, wants_newsletter:newsChkBox.checked}
